...
### 第 1 步：装上 Skill / Python 环境安装

```bash
pip install tencentdb-agent-memory
```

> 💡 **提示**：安装过程自动集成 PostgreSQL 向量扩展适配器，10 秒内即可准备就绪！

---

### 第 2 步：做变量替换 / 配置向量数据库与 LLM
...
> 将上述配置替换为你本地或腾讯云的 PostgreSQL 数据库连接串与 OpenAI/DeepSeek 密钥！

---

### 第 3 步：改问题，靠脑力干 / 在 Python 中自动学习与记忆
