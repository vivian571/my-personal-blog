...
### 第 1 步：装上 Skill / GUI 桌面 App 一键同步
...
> 💡 **提示**：命令行脚本会自动识别你电脑上的 Cursor、Claude Code 与 Windsurf 配置路径并注入角色！

---

### 第 2 步：做变量替换 / 勾选你需要的专精团队

打开 Desktop GUI 界面：
(1) 勾选你当前正在使用的 AI 编程编辑器；  
(2) 在 100+ 角色列表中勾选你需要注入的核心专家（如：`Backend Architect`, `Security Engineer`, `Reality Checker`）。

> 点击【Install to Tools】，所有专精角色的 Markdown 定义瞬间绑定到你的开发环境中！

---

### 第 3 步：改问题，靠脑力干 / 随时唤醒专精专家

在 Cursor 或 Claude Code 对话框中，直接唤醒：
